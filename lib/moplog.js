...
var Moplog = function (configFile, consumerDir) {
    ...
    consumerNames.forEach(function (name) {
...
Moplog.prototype.processOplogStream = function () {
    ...
    this.mongoStream.on('data', this.onData.bind(this));

    this.mongoStream.on('end', this.onEnd.bind(this));

    this.mongoStream.on('error', this.onError.bind(this));
};
